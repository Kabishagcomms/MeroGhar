  ...
  return (
    <main>
      ...
      <div className="my-3 ">
        {!showOTP && (
          <div>
            <label className=" text-md mb-2 block font-semibold text-slate-700">
              Phone Number
            </label>
        ...
        {showOTP && (
          <div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={onOTPVerify}
                className="rounded-lg border border-white bg-themeColor p-2 px-4 font-semibold text-white transition-all hover:bg-mainColor"
              >
                Verify Code
              </button>
            </div>
