  ...
  return (
    <button
      onClick={(e) => {
        ...
        if (active) {
          ...
          const res = Api.delete(`/property/v1/wishList/${id}`, {
            withCredentials: true,
          })
            .then((res) => {
    ...
    >
      <svg
        ...
        className={
          isActive
            ? 'stroke-gray-100  h-7 w-7 fill-[#59b077]'
            : 'fill-gray-400 stroke-gray-100 h-7  w-7  transition-all  hover:stroke-[#66cd8b]'
        }
      >
        <path
          strokeLinecap="round"
