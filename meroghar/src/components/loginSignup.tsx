...
export default function LoginSignup({
  ...
  const style1 =
    'bg-white border-2 border-gray-200 flex  flex-col items-center justify-center rounded-lg shadow-lg md:w-[540px]'

  return (
    <div className={style1}>
      <div className=" my-5 flex w-full items-center  border-b-2 border-gray-200 p-3">
