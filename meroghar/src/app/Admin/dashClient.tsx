...
export default  function DashClient({totalBookings,totalProperties,totalUsers,activeBookings,activeProperties,activeUsers,properties}:dashData){
    ...
    return(
        ...
        <h1 className="text-lg mb-5 font-semiBold  sm:text-2xl sm:font-bold ">Data Over View</h1>
       ...
       <h2 className='text-xl font-bold my-8 '>Most Popular Properties Right now!</h2>
